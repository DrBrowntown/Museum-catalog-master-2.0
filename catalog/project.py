...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/museum-catalog/catalog/fb_client_secrets.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('/var/www/museum-catalog/catalog/fb_client_secrets.json', 'r').read())['web']['app_secret']
